...
bool	is_minishell_builtin(char *cmd)
{
	if (ft_strncmp(cmd, "echo",
			ft_strlen("echo")) == 0 && (ft_strlen(cmd) == ft_strlen("echo")))
		return (true);
	else if (ft_strncmp(cmd, "cd",
			ft_strlen("cd")) == 0 && (ft_strlen(cmd) == ft_strlen("cd")))
		return (true);
	else if (ft_strncmp(cmd, "pwd",
			ft_strlen("pwd")) == 0 && (ft_strlen(cmd) == ft_strlen("pwd")))
		return (true);
		...
		return (true);
			...
			ft_strlen("unset")) == 0 && (ft_strlen(cmd) == ft_strlen("unset")))
		return (true);
	else if (ft_strncmp(cmd, "env",
			ft_strlen("env")) == 0 && (ft_strlen(cmd) == ft_strlen("env")))
		return (true);
	else if (ft_strncmp(cmd, "exit",
			ft_strlen("exit")) == 0 && (ft_strlen(cmd) == ft_strlen("exit")))
		return (true);
	return (false);
}
