...
static void malloc_for_process(t_pipex *pipe_x, int count, t_context *context, int *heredoc_status)
{
...
static void malloc_for_pipe_fd(t_pipex *pipe_x, int count, t_context *context, int *heredoc_status)
{
    int i;
...
static void stash_stdin_stdout(t_pipex *pipe_x, t_parser *parser_head, t_context *context, int *heredoc_status)
...
//process count is 3
//pipe_fd count is 2
void init_pipex(t_parser *parser_head, t_pipex *pipe_x, t_context *context, int *heredoc_status)
{
    int count;
